        ...
        text += (
            ...
            + "\n".join(
                ...
                for name in (
                    ...
                    "checkpoint2-resume-approval-2.json",
                    "checkpoint2-resume-outcome-2.md",
                    "checkpoint2-resume-proposal-3.json",
                    "checkpoint2-resume-approval-3.json",
                    "checkpoint2-resume-outcome-3.md",
                    "checkpoint2-resume-proposal-4.json",
