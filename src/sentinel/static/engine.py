...
_AST_DETECTORS: dict[str, AstDetector] = {
    ...
    "SENT-015": sent015.detect,
    "SENT-016": sent016.detect,
}
...
def _finding_from_match(
    ...
    return Finding(
        ...
        description=(
            ...
            else "A resolved copy of the originating caller path passed a directory "
            "containment check. This operation uses a reconstructed or derived path; "
            "equivalence and containment at filesystem use are not established."
            if match.captures.get("containment_gap") == "resolved-copy"
