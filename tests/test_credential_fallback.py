...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "client=aiohttp.ClientSession(base_url='https://other.example/', "
            "auth=aiohttp.BasicAuth('service', token))",
            "",
            0,
        ),
        (
            "client=aiohttp.ClientSession(base_url='https://api.example.com:443/', "
            "auth=aiohttp.BasicAuth('service', token))",
            "",
            1,
        ),
