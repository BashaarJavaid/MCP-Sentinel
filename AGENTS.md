...
- [ ] Phase 22 — MCP coverage and compatibility expansion (all three exposed SSRF gates and four Linux diagnostic observations pass; full timing, fresh evaluation and acceptance pending; paid benchmark/pilots deferred)
