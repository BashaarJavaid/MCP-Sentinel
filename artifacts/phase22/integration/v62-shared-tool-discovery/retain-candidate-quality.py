...
out = root / "artifacts/phase22/integration/v62-candidate-quality"
...
packet = {
    "source": head,
    "candidate_product_scanner": "1948bf942babce155b701f5b22ed941eb16d99d0",
    "runs": {},
    "archives": {},
    "artifact_files": [],
    "classification": "Fresh ordinary CI for shared tool-discovery reuse revision at1948bf9. Optional exposed corpus evaluation remains unapproved and skipped. Historical reproductions retain pinned scanner8824014; no current-source corpus run or paid call.",
}
pending = json.loads(
    (root / "artifacts/phase22/integration/v62-shared-tool-discovery/candidate-run-ids.json").read_text()
)
while pending:
