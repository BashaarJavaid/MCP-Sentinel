...
replay=json.loads((BASE/'v62-production-capture-revalidation/packet.json').read_text());prior=json.loads((BASE/'v19-final-production-capture-revalidation/packet.json').read_text())
assert replay['source']=='1948bf942babce155b701f5b22ed941eb16d99d0' and replay['model_calls']==0
