...
fixed=Path('/private/tmp/mcp-phase22-frozen-1948bf9');revision='1948bf942babce155b701f5b22ed941eb16d99d0';assert not fixed.exists()
...
assert json.loads((OUT.parent/'v62-full-suite.json').read_text())['exit_code']==0
quality=json.loads((OUT.parent/'v62-candidate-quality/packet.json').read_text());assert quality['engineering_passed'] and quality['source']==revision
audit=json.loads((OUT.parent/'v62-candidate-quality-audit/packet.json').read_text());assert audit['source']==revision and len(audit['quality'])==12
