...
import subprocess
bad=out/'wrong-root-worker.py';bad.write_text(worker.read_text().replace('/private/tmp/mcp-phase22-frozen-a36f696','/private/tmp/mcp-phase22-frozen-6e4fd67'))
