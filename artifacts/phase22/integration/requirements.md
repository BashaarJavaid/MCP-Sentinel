...
| R79 | Lossless numbered evidence batch after v3; per-file hash readback/extraction | Integration archives and command wrapper | Verified v14 adds 251 files through `18e385f`, including finished native nine-input outcomes, later service/URL corrections and retained failures; every member read back; earlier seals and coverage preserved |
