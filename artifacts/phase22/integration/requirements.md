...
| R79 | Lossless numbered evidence batch after v3; per-file hash readback/extraction | Integration archives and command wrapper | Verified v7 preserves 531 added/changed files through `2a332f2`, including dirty handoff recovery and fixed-source coverage; per-file readback passed; sealed v1–v6 preserved |
...
| R81 | Reviewable local commits on single integration branch; preserve old drafts | Git history and PRs #22–36 | Local commits through `2a332f2`; original dirty work preserved and committed after regression fixes; no repeated parent updates/pushes |
