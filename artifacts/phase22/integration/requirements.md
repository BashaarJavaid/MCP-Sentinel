...
| R63 | Historical 45-input deterministic repeat pair, 120s deadline | Existing Phase 20 runner | PASS at immutable 6e68331: 45/45 completed twice under unchanged 120s/input, identical stable reports and zero model calls. All 45 stable reports also match dcb965f. v2-historical-gate-6e68331 binds actual report hashes, both results and repeatability. All earlier incomplete runs remain preserved. |
| R64 | All 20 vulnerable condition hits; zero fixed/safe condition alerts | Frozen condition scorer + per-input adjudication | PASS at 6e68331 through exact stable-report identity: 20/20 exposed vulnerable conditions, zero named fixed/safe alerts across 25 partners/controls. The dcb965f source-condition score and all per-instance judgments remain linked without changing labels or suppressing warnings. No fresh accuracy, model retention or human acceptance is implied. |
