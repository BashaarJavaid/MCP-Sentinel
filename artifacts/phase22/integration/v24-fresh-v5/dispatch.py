...
ASSETS = OUT.parent / "v23-fresh-v5"
...
def main():
    ...
    packet = {
        ...
        "authorization_sha256": runner.sha(ASSETS / "authorization.json"),
        "binding_sha256": runner.sha(ASSETS / "binding.json"),
