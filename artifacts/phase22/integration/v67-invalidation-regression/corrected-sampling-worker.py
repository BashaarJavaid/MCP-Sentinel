...
root=Path('/private/tmp/mcp-phase22-frozen-4145d35');sys.path[:0]=[str(root/'src'),str(root)]
...
EXPECTED_SCANNER = {'revision': '4145d3559c5300a5003ca8e3368c8da49fb51f91', 'source_sha256': '41dd31a167c454bd9db3d720ce75ce6287312ce0e7799bbda1b2e59c61f77ea6', 'harness_sha256': '9bfc9229b7ec7d23580c44f2306edb9274bc1d2a3c2261d01db0445b8b480add'}
def verify_scanner():
