...
for folder in ['v73-corrected-four-results','v75-prior-language-results']:
    budget=json.loads((ROOT/'artifacts/phase22/integration'/folder/'raw/packet.json').read_text())
    assert budget['budget_closed'] and len(budget['attempts']) == (24 if folder.startswith('v73') else 181)
