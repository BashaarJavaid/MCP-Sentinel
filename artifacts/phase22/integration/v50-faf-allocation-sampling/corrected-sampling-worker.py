...
root=Path('/private/tmp/mcp-phase22-frozen-6e4fd67');sys.path[:0]=[str(root/'src'),str(root)]
...
EXPECTED_SCANNER = {'revision': '6e4fd671a97d92f6297dffc900c4dd9e18faad2c', 'source_sha256': 'd1d24e53db3dc112639aaedcfd6a03102188e29d3007fcfc823d2b1b015cc2ed', 'harness_sha256': '9bfc9229b7ec7d23580c44f2306edb9274bc1d2a3c2261d01db0445b8b480add'}
def verify_scanner():
