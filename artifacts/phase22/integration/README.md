# Integration evidence, batches 1–66 and closeout audit
...
Review [passed exposed regression](v38-guard-regression/assessment.json), [89 + 108 row audit](v38-guard-regression/audit-final.json) and [explicit technical acceptance proposal](v38-guard-regression/acceptance-proposal-final.json). Restore seal 66 after seals 1–65, verifying every archive and member hash. The [original fresh result](v33-fresh-v6/assessment.json) and [v35 failed regression](v35-ddg-regression/assessment.json) remain unchanged.
