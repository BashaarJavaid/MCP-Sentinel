# Integration evidence, batches 1–68 and closeout audit
...
Review the [first-frozen evaluation](v40-fresh-v7/assessment.json), [89 + 112 row audit](v40-fresh-v7/audit.json) and [unapproved focused correction proposal](v40-fresh-v7/recovery-proposal.json). Restore seal 68 after seals 1–67, verifying every archive/member hash. Vulnerable detection passes, fixed/control discrimination fails; technical acceptance remains pending.
