# Integration evidence, batches 1–96 and closeout audit

## Current profile and recovery evidence seal 96

[Seal 96](evidence-v96.json) retains **147 members / 164,662,081 raw bytes**,
archive SHA-256 `90f9898a458ce3a6c1ae243fa2b798689beb0ab0ab15a1509d2ad91cbca1b0e0`. All 95 earlier archives and every member verified.
...
[Seal 90](evidence-v90.json) retains **504 members / 20,201,254 raw bytes**,
archive SHA-256 `de7b4a097edbb2cc6f1aa6056eefa5f9592c8ad16e3fbb26105ff802094aa91f`. All 89 earlier archives and every member verified.
...
[Seal 87](evidence-v87.json) retains **473 members / 16,824,463 raw bytes**,
archive SHA-256 `c89178fd2c2794ce28d0b4cc8b32d9259777f7fca567c0feadb0c1a082a6cfec`. All 86 prior archives and every member verified.
...
[Seal 84](evidence-v84.json) retains **80 members / 4,279,222 raw bytes**;
archive SHA-256 `03c951be5fdcb59e8fabb31755b8b69fabe601fdade7b1e56bbf410b6889f27b`. All 83 preceding archives and every member
verified. The canonical bypass failed synthetic environment equivalence after cache eviction
and was reverted. Candidate/baseline, the eviction counterexample, all 297 audit
rows and one explicit unapproved equal-marker credential contract revision plus
canonical bypass proposal are preserved. Final docs/packages and supplemental
v55 delivery records are retained. Restore seals 1–84 in order into safe separate
...
[Seal 83](evidence-v83.json) retains **85 members / 4,157,050 raw bytes**;
archive SHA-256 `b4bca1a6b4e589c4342a58de91d142668f10e45adceb55edf28747a7bdead1e7`. All 82 preceding archives and every member
...
[Seal 76](evidence-v76.json) retains **508 members / 50,624,123 raw bytes**,
archive SHA-256 `ec3ff2d52ca96d5c312a912d80189f072c71c36ca41b8ab5eba350dea50080c7`. All 75 prior archives and every member
...
archive SHA-256 `6a06288474da6e634a417ff46c336f27ddfad2514c4c88b710a674a58abba110`. All 73 prior archives and every member
...
archive SHA-256 `464278ce1fbea2d0d61c940e24e3d112a59b107901e0c361d9effc141d60a958`. It binds the verified `17b4784` source
...
Review the [94-observation assessment](v42-path-guard-regression/assessment.json), [89 + 115 row audit](v42-path-guard-regression/audit.json) and [explicit acceptance proposal](v42-path-guard-regression/acceptance-proposal.json). Restore seal 70 after seals 1–69, verifying every archive/member hash. Original fresh failures remain preserved; technical acceptance is pending.
...
Review [current summary](v33-fresh-v6/summary.md), [89 + 88 row audit](v33-fresh-v6/audit.json), [source-assessed evaluation](v33-fresh-v6/assessment.json) and [exact acceptance proposal](v33-fresh-v6/acceptance-proposal.json). Restore seal 60 after seals 1–59, verifying archive/member hashes in numeric order.
...
Evidence for this checkpoint is retained in `evidence-v59.json` /
`evidence-v59.tar.gz`; restore after seals 1–58. The new corpus source archives
are directly tracked under `artifacts/phase22/corpus-replacement-v6/`.

## Historical v31 technical acceptance checkpoint

Review the [technical acceptance summary](v31-compatibility/summary.md), [89 + 83 row audit](v31-compatibility/audit.json), [exact acceptance proposal](v31-compatibility/acceptance-proposal.json) and [completed compatibility assessment](v31-compatibility/assessment.json). Restore seal 58 after seals 1–57; verify every archive/member hash using the existing numeric restoration procedure.
...
Review the [current summary](v30-lighthouse-regression/summary.md), [89 + 81 row audit](v30-lighthouse-regression/audit.json), [passed evaluation](v30-lighthouse-regression/assessment.json) and [exact unapproved compatibility proposal](v30-compatibility-proposal/evaluation-proposal.json). Restore seal 57 after seals 1–56 using the existing numeric-order procedure; verify all archive/member hashes.
...
Review the [current summary](v29-loopback-fix/summary.md), [89 + 78 row audit](v29-loopback-fix/audit.json), [stopped regression](v28-lighthouse-regression/assessment.json) and [exact unapproved proposal](v29-loopback-fix/evaluation-proposal.json). Restore seal 56 after seals 1–55 using the existing numeric-order procedure and verify every archive/member hash.
...
Review the [current summary](v27-constructor-fix/summary.md), [89 + 72 row audit](v27-constructor-fix/audit.json), [stopped regression](v26-lighthouse-regression/assessment.json) and [exact unapproved proposal](v27-constructor-fix/evaluation-proposal.json).
...
Review the [correction summary](v25-lighthouse-fix/summary.md),
...
Review the [current summary](v24-fresh-v5/summary.md), [89 + 60 row audit](v24-fresh-v5/audit.json),
[measured assessment](v24-fresh-v5/assessment.json) and [pending limitation proposal](v24-fresh-v5/limitation-proposal.json).
Restore seal 53 after seals 1–52 using the existing numeric-order procedure and
verify every archive/member hash; preserve historical conflicts for explicit review.
The final documentation/delivery bindings are tracked after seal 53.
