...
out = root / "artifacts/phase22/integration/v66-candidate-quality"
...
packet = {
    "source": head,
    "candidate_product_scanner": "4145d3559c5300a5003ca8e3368c8da49fb51f91",
    "runs": {},
    "archives": {},
    "artifact_files": [],
    "classification": "Fresh ordinary CI for approved private invalidation accumulator revision at4145d35. Optional exposed corpus evaluation remains unapproved and skipped. Historical reproductions retain pinned scanner8824014; no current-source corpus run or paid call.",
}
pending = json.loads(
    (root / "artifacts/phase22/integration/v66-invalidation-contract/candidate-run-ids.json").read_text()
)
while pending:
