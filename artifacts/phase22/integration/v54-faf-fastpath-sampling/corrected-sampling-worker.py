...
root=Path('/private/tmp/mcp-phase22-frozen-a36f696');sys.path[:0]=[str(root/'src'),str(root)]
...
EXPECTED_SCANNER = {'revision': 'a36f696c504e4e8d1f90de5dc84e8942d06316ca', 'source_sha256': '2f4a49aeb2173ca2174b984b8108174d96d6df42cec93e58522caf713efbaeab', 'harness_sha256': '9bfc9229b7ec7d23580c44f2306edb9274bc1d2a3c2261d01db0445b8b480add'}
def verify_scanner():
