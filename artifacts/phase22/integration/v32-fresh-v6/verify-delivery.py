...
root = Path.cwd()
out = root / "artifacts/phase22/integration/v32-fresh-v6"
...
receipt = {
    ...
    "new_evaluation_approved": False,
    "new_evaluation_executed": False,
    "new_corpus_observations": 0,
    "source_only_proposal_delivered": True,
    "fresh_detection_prerequisite_unmet": True,
