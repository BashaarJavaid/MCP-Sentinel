...
out = root / "artifacts/phase22/integration/v57-candidate-quality"
...
packet = {
    "source": head,
    "candidate_product_scanner": "dc7371513a065457af566f4b589b9ed147130d64",
    "runs": {},
    "archives": {},
    "artifact_files": [],
    "classification": "Fresh ordinary CI for credential-join correction and canonical bypass atdc73715. Optional exposed corpus evaluation remains unapproved and skipped. Historical reproductions retain pinned scanner8824014; no current-source corpus run or paid call.",
}
pending = json.loads(
    (root / "artifacts/phase22/integration/v57-credential-merge/candidate-run-ids.json").read_text()
)
while pending:
