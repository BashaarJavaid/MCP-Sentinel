...
fixed=Path('/private/tmp/mcp-phase22-frozen-dc73715');revision='dc7371513a065457af566f4b589b9ed147130d64';assert not fixed.exists()
...
assert json.loads((OUT.parent/'v57-full-suite.json').read_text())['exit_code']==0
quality=json.loads((OUT.parent/'v57-candidate-quality/packet.json').read_text());assert quality['engineering_passed'] and quality['source']==revision
audit=json.loads((OUT.parent/'v57-candidate-quality-audit/packet.json').read_text());assert audit['source']==revision and len(audit['quality'])==12
