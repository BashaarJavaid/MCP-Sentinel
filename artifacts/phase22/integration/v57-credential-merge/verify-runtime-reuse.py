...
replay=json.loads((BASE/'v57-production-capture-revalidation/packet.json').read_text());prior=json.loads((BASE/'v19-final-production-capture-revalidation/packet.json').read_text())
assert replay['source']=='dc7371513a065457af566f4b589b9ed147130d64' and replay['model_calls']==0
