...
root=Path('/private/tmp/mcp-phase22-frozen-dc73715');sys.path[:0]=[str(root/'src'),str(root)]
...
EXPECTED_SCANNER = {'revision': 'dc7371513a065457af566f4b589b9ed147130d64', 'source_sha256': '4f3e5b2e9c89f61d179ac82db94ced06e83033f9cf1640644cefb53326e96eb9', 'harness_sha256': '9bfc9229b7ec7d23580c44f2306edb9274bc1d2a3c2261d01db0445b8b480add'}
def verify_scanner():
 from scripts import phase20_measurements as harness
 from sentinel.static import typescript_path_flow
 assert harness.ROOT.resolve()==root.resolve(), 'Harness import root mismatch'
 imports={name:str(Path(module.__file__).resolve()) for name,module in [('workers',workers),('typescript_path_flow',typescript_path_flow)]}
