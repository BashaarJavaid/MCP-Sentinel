...
import subprocess
bad=out/'wrong-root-worker.py';bad.write_text(worker.read_text().replace('/private/tmp/mcp-phase22-frozen-7bf4c6e','/private/tmp/mcp-phase22-frozen-dc73715'))
