...
root = Path.cwd()
out = root / "artifacts/phase22/integration/v31-compatibility"
...
assert (out.parent / "v30-compatibility-proposal/evaluation-authorization.json").exists()
...
receipt = {
    ...
    "new_paid_calls": 0,
    "current_source_corpus_observations": 64,
    "prior_scanner_regression_observations_this_continuation": 0,
    "evaluation_approved": True,
    "evaluation_passed": True,
    "compatibility_proposal_approved": True,
    "compatibility_observations": 54,
    "acceptance_packet_delivered": True,
