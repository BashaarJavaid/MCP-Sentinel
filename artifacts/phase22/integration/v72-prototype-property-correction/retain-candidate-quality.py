...
out = root / "artifacts/phase22/integration/v72-candidate-quality"
...
packet = {
    "source": head,
    "candidate_product_scanner": "cec0322e904bbf63c33cd95796e7289101a93e5d",
    "runs": {},
    "archives": {},
    "artifact_files": [],
    "classification": "Fresh ordinary CI for approved-contract constructor parameter-property and derived URL guard corrections atcec0322. Optional exposed corpus evaluation remains unapproved and skipped. Historical reproductions retain pinned scanner8824014; no current-source corpus run or paid call.",
}
pending = json.loads(
    (root / "artifacts/phase22/integration/v72-prototype-property-correction/candidate-run-ids.json").read_text()
)
while pending:
