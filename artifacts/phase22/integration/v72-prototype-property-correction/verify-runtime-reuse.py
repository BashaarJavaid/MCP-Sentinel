...
replay=json.loads((BASE/'v72-production-capture-revalidation/packet.json').read_text());prior=json.loads((BASE/'v19-final-production-capture-revalidation/packet.json').read_text())
assert replay['source']=='cec0322e904bbf63c33cd95796e7289101a93e5d' and replay['model_calls']==0
...
protected=json.loads((OUT/'intake.json').read_text())['protected_user_files_sha256']
