...
assert read(base/'v72-full-suite.json')['exit_code']==0
assert read(out/'owned-final.json')['owned_processes']==[]
from datetime import datetime
start=datetime.fromisoformat(read(base/'v71-four-source-correctness/intake.json')['recorded_at']).timestamp()
end=datetime.fromisoformat(read(base/'v72-full-suite.json')['recorded_at']).timestamp()
