...
root=Path('/private/tmp/mcp-phase22-frozen-7bf4c6e');sys.path[:0]=[str(root/'src'),str(root)]
...
EXPECTED_SCANNER = {'revision': '7bf4c6e1cf0c8d83229b1273f80737e7cacc5b82', 'source_sha256': '40c194dcd47a152f78c9b9dc57b40e5e77026f6052035841c0af63b83f234af6', 'harness_sha256': '9bfc9229b7ec7d23580c44f2306edb9274bc1d2a3c2261d01db0445b8b480add'}
def verify_scanner():
