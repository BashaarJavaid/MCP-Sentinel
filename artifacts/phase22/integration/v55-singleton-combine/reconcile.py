...
assert audit['additional_scope_dispositions'] == {'passed':182, 'unresolved':13, 'proposed documented limitation awaiting decision':6}, audit['additional_scope_dispositions']
