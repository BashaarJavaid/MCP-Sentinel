...
replay=json.loads((BASE/'v59-production-capture-revalidation/packet.json').read_text());prior=json.loads((BASE/'v19-final-production-capture-revalidation/packet.json').read_text())
assert replay['source']=='7bf4c6e1cf0c8d83229b1273f80737e7cacc5b82' and replay['model_calls']==0
...
protected=json.loads((BASE/'v44-four-fresh-evaluation/documentation-binding.json').read_text())['user_files_sha256']
