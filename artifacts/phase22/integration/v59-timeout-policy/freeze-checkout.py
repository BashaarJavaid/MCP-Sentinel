...
fixed=Path('/private/tmp/mcp-phase22-frozen-7bf4c6e');revision='7bf4c6e1cf0c8d83229b1273f80737e7cacc5b82';assert not fixed.exists()
...
assert json.loads((OUT.parent/'v59-full-suite.json').read_text())['exit_code']==0
quality=json.loads((OUT.parent/'v59-candidate-quality/packet.json').read_text());assert quality['engineering_passed'] and quality['source']==revision
audit=json.loads((OUT.parent/'v59-candidate-quality-audit/packet.json').read_text());assert audit['source']==revision and len(audit['quality'])==12
